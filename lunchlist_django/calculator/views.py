...
def summit(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            price = format(form.cleaned_data['price'],'.2f')
            ...
            first_class_cost_wini_us = format(float(First_Class_Cost(weight,first_class_rate_us)),'.2f')
            second_class_wini_us = second_class_wini_us
            commission_cost_us = format(Commission_Cost(price,commission_rate,exchange_rate_us),'.2f')
            ...
            gross_profit_wini_us = format(Gross_Profit(price,total_cost_wini_us,exchange_rate_us),'.2f')
            profit_margins_wini_us = format(Profit_margins(gross_profit_wini_us,price,exchange_rate_us),'.2f')
            zero_sale_price_wini_us = format(no_commission_cost/exchange_rate_us/0.82,'.2f')
            five_sale_price_wini_us = format(no_commission_cost/0.77/exchange_rate_us,'.2f')
            ten_sale_price_wini_us = format(no_commission_cost/0.72/exchange_rate_us,'.2f')
            fifteen_sale_price_wini_us = format(no_commission_cost/0.67/exchange_rate_us,'.2f')
            twenty_sale_price_wini_us = format(no_commission_cost/0.62/exchange_rate_us,'.2f')
            twentyfive_sale_price_wini_us = format(no_commission_cost/0.57/exchange_rate_us,'.2f')
            thirty_sale_price_wini_us = format(no_commission_cost/0.52/exchange_rate_us,'.2f')


            first_class_cost_cn_us = format(float(First_Class_Cost(weight,first_class_rate_us)),'.2f')
            second_class_cn_us = format(float(second_class_cn_us),'.2f')
            commission_cost_us = format(Commission_Cost(price,commission_rate,exchange_rate_us),'.2f')
            ...
            gross_profit_cn_us = format(Gross_Profit(price,total_cost_cn_us,exchange_rate_us),'.2f')
            profit_margins_cn_us = format(Profit_margins(gross_profit_cn_us,price,exchange_rate_us),'.2f')
            zero_sale_price_cn_us = format(no_commission_cost/exchange_rate_us/0.82,'.2f')
            five_sale_price_cn_us = format(no_commission_cost/0.77/exchange_rate_us,'.2f')
            ten_sale_price_cn_us = format(no_commission_cost/0.72/exchange_rate_us,'.2f')
            fifteen_sale_price_cn_us = format(no_commission_cost/0.67/exchange_rate_us,'.2f')
            twenty_sale_price_cn_us = format(no_commission_cost/0.62/exchange_rate_us,'.2f')
            twentyfive_sale_price_cn_us = format(no_commission_cost/0.57/exchange_rate_us,'.2f')
            thirty_sale_price_cn_us = format(no_commission_cost/0.52/exchange_rate_us,'.2f')



            first_class_cost_mulfba_us = format(float(First_Class_Cost(weight,first_class_rate_us)),'.2f')
            second_class_mulfba_us = format(float(second_class_mulfba_us),'.2f')
            commission_cost_us = format(Commission_Cost(price,commission_rate,exchange_rate_us),'.2f')
            ...
            gross_profit_mulfba_us = format(Gross_Profit(price,total_cost_mulfba_us,exchange_rate_us),'.2f')
            profit_margins_mulfba_us = format(Profit_margins(gross_profit_mulfba_us,price,exchange_rate_us),'.2f')
            zero_sale_price_mulfba_us = format(no_commission_cost/exchange_rate_us/0.82,'.2f')
            five_sale_price_mulfba_us = format(no_commission_cost/0.77/exchange_rate_us,'.2f')
            ten_sale_price_mulfba_us = format(no_commission_cost/0.72/exchange_rate_us,'.2f')
            fifteen_sale_price_mulfba_us = format(no_commission_cost/0.67/exchange_rate_us,'.2f')
            twenty_sale_price_mulfba_us = format(no_commission_cost/0.62/exchange_rate_us,'.2f')
            twentyfive_sale_price_mulfba_us = format(no_commission_cost/0.57/exchange_rate_us,'.2f')
            thirty_sale_price_mulfba_us = format(no_commission_cost/0.52/exchange_rate_us,'.2f')
            ...
            second_class_eub_us = format(float(second_class_eub_us),'.2f')
            commission_cost_us = format(Commission_Cost(price,commission_rate,exchange_rate_us),'.2f')
            ...
            gross_profit_eub_us = format(Gross_Profit(price,total_cost_eub_us,exchange_rate_us),'.2f')
            profit_margins_eub_us = format(Profit_margins(gross_profit_eub_us,price,exchange_rate_us),'.2f')
            zero_sale_price_eub_us = format(no_commission_cost/exchange_rate_us/0.82,'.2f')
            five_sale_price_eub_us = format(no_commission_cost/0.77/exchange_rate_us,'.2f')
            ten_sale_price_eub_us = format(no_commission_cost/0.72/exchange_rate_us,'.2f')
            fifteen_sale_price_eub_us = format(no_commission_cost/0.67/exchange_rate_us,'.2f')
            twenty_sale_price_eub_us = format(no_commission_cost/0.62/exchange_rate_us,'.2f')
            twentyfive_sale_price_eub_us = format(no_commission_cost/0.57/exchange_rate_us,'.2f')
            thirty_sale_price_eub_us = format(no_commission_cost/0.52/exchange_rate_us,'.2f')
